...
function NavBar (props) {
    ...
    const guardarNuevaContraseñaUsr => () {
                ...
                const data = await fetch (
                    ...
                    .then( json => {
                        ...
                        $('#usrPassModal').modal('toggle');
                            ...
                            if (cerrarSesion) {
                                props.mensajeErrorWS('Actualizar Contraseña', json.errores, cerrarSesion);
                            } else {
                                props.mensajeErrorWS('Actualizar Contraseña', json.errores);
                            }
                        }
                    } )
            } catch (error) {
        ...
        <div>
            <nav className="navbar navbar-expand-sm navbar-dark bg-dark pr-4 pl-4 shadow changecolor">
                ...
                <Link className="navbar-brand text-light" to="/">
                    ...
                    <span className="ml-2 text-center text-small text-white mb-1 pt-0"> Ver: {props.version}</span>
                </Link>
                ...
                <div className="collapse navbar-collapse ml-4" id="navbarNavDropdown">
                    ...
                    <ul className="navbar-nav">
                        ...
                        {this.props.isLogueado() &&
                            <li className="nav-item">
                                <Link to="#" onClick={onClickCerrarSesion}>Cerrar Sesión</Link>
                            </li>
                        }
                    ...
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                            ...
                            <div className="modal-body p-4">
                                <h4><b>Nombre</b> {props.nombreUsuario}</h4>
                                <br></br>
                                <h4><b>Apellido</b> {props.apellidoUsuario}</h4>
                            </div>
                    ...
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                            ...
                            <div className="modal-footer">
                                ...
                                <div>
                                    <button className="btn btn-dark" onClick={guardarNuevaContraseñaUsr}>
